 ...
 * Example usage:
 * ```
 *     return res.imATeapot();
 *     // -or-
 *     return res.imATeapot(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function imATeapot(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.imATeapot()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.imATeapot()` called with an Error:', optionalData);
